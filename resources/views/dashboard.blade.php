          ...
          <main class="content px-3 py-2">
           ...
           @endif
               <div class="container-fluid">
                    <div class="mb-2">
                         <h4 class="fw-bold">{{ Auth::user()->role }} Dashboard</h4>
                         <a class="list-group-item-action disabled" tabindex="-1" aria-disabled="true">Dashboard</a>
                     </div>
                    <div class="row">
                         <div class="container px-2 ">
                              <div class="row g-3 my-2 mb-3">
                                   <div class="col-md-7">
                                        ...
                                        <div>
                                             <h3 class="fs-2">{{ count(App\Models\letter::all()) }}</h3>
